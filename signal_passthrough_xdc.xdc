...
# Switches
set_property PACKAGE_PIN V17 [get_ports get_data]
	set_property IOSTANDARD LVCMOS33 [get_ports get_data]
...
#set_property PACKAGE_PIN U17 [get_ports get_data]
#set_property IOSTANDARD LVCMOS33 [get_ports get_data]
...
##Pmod Header JB
#Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports cs1]
set_property IOSTANDARD LVCMOS33 [get_ports cs1]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports data_bit]
set_property IOSTANDARD LVCMOS33 [get_ports data_bit]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {JB[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB[2]}]
#Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports sclk1]
...
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {ldac}]
set_property IOSTANDARD LVCMOS33 [get_ports {ldac}]
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {sclk2}]
